...
The results will be stored into a `google_career_data.json` in your project directory.
Using the search_term as `filter as Michigan City,IN,USA in Google Careers`, we get the sample data shown below.
